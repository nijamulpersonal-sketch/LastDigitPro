...
import { ChevronLeft, Mail, Lock, LogIn, UserPlus, ShieldCheck } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-900 text-white font-sans selection:bg-amber-500/30 overflow-hidden relative">
      ...
      <div className="max-w-md mx-auto p-6 mt-8 relative z-10">
        <div className="text-center mb-8 space-y-2">
          ...
          <p className="text-gray-400 text-sm">{isRegistering ? "Join our premium prediction community" : "Login to access your VIP dashboard"}</p>
        </div>
        ...
        <div className="glass rounded-[2.5rem] p-8 border border-white/10 shadow-2xl relative overflow-hidden">
          ...
          <form onSubmit={handleAuth} className="space-y-6">
            ...
            >
              ...
              {loading ? "Processing..." : (isRegistering ? "Sign Up Now" : "Login Securely")}
            </button>
          </form>
